...
#ifndef ESP8266
// SBR adds a large malloc'ed state and complex decode path; disabled here to
// keep LC (standard) AAC playback stable on PSRAM-heap targets. HE-AAC streams
// will still decode at their core rate (no spectral band replication).
