...
typedef struct _PSInfoBase {
    ...
    int                   commonWin;
    short                 scaleFactors[MAX_NCHANS_ELEM][MAX_SF_BANDS + 16];
    unsigned char         sfbCodeBook[MAX_NCHANS_ELEM][MAX_SF_BANDS + 16];
    ...
    int                   coef[MAX_NCHANS_ELEM][AAC_MAX_NSAMPS + 16];
    ...
    int                   overlap[AAC_MAX_NCHANS][AAC_MAX_NSAMPS + 16];
